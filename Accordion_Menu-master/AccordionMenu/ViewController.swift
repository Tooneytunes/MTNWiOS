...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        arrayForBool = ["0","0"]
        sectionTitleArray = ["Mijn Vakken","Mijn Werkplekken"]
        var tmp1 : NSArray = ["Engels","Frans","Natuurkunde"]
        var string1 = sectionTitleArray .objectAtIndex(0) as? NSString
        [sectionContentDict .setValue(tmp1, forKey:string1! as String )]
        var tmp2 : NSArray = ["Lokaal"]
        string1 = sectionTitleArray .objectAtIndex(1) as? NSString
        [sectionContentDict .setValue(tmp2, forKey:string1! as String )]
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int{
        ...
        if(arrayForBool .objectAtIndex(section).boolValue == true)
        {
            ...
            var count1 = (sectionContentDict .valueForKey(tps as String)) as! NSArray
            return count1.count
        }
        return 0;
    }
