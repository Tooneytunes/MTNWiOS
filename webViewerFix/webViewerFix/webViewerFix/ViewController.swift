...
//  webViewer
//
//  Created by Toon van Dort & Johan van der Meulen on 02/03/15.
//  Copyright (c) 2015 Toon van Dort & Johan van der Meulen. All rights reserved.
//
...
//  This script inherits from the webViewer in the
//  Github map, but that file didnt work because of
//  broken cocaopods. This is the fresh and remade
//  version
...
//    }
    ...
    @IBAction func homeButton(inputText: UIButton) {
        var homeUrl = NSURL(string: "http://www.google.com")
        var homeReq = NSURLRequest(URL:homeUrl!)
        uiWebView!.loadRequest(homeReq)
    }
